...
class TimeMixer(BaseTimeSeriesModel):

    def __init__(self, seq_len, label_len, pred_len, down_sampling_window, channel_independence, num_layers,
                moving_avg, enc_in, d_model, d_ff, embed, freq, dropout, use_norm, down_sampling_layers, c_out, down_sampling_method,
                decomp_method, top_k):
