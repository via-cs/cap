...
extensions = [
    'm2r2',  # NOTE: This requires mistune==0.8.4 and conflicts with nbsphinx
    'nbsphinx',  # NOTE: This requires mistune>=2.0.3 and conflicts with m2r2
    'sphinx.ext.autodoc',
...
source_suffix = ['.rst', '.md']  # Restored original configuration
...
version = cap.__version__
# The full version, including alpha/beta/rc tags.
release = cap.__version__
...
html_theme_options = {
    "github_url": "https://github.com/anonymous/cap",
    "show_prev_next": True,
}
...
# html_logo = 'images/cap-logo-white-200.png'
